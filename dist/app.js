...
(() => {
  ...
  async function createFilterOptionIngredient(search) {
    ...
    ingredientsList.forEach((ingredientElement) => {
      if (!selectedIngredient.includes(ingredientElement) && (search == void 0 || search == "" || ingredientElement.includes(search))) {
  ...
  async function createFilterOptionAppliance(search) {
    ...
    applianceList.forEach((applianceElement) => {
      if (!selectedAppliance.includes(applianceElement) && (search == void 0 || search == "" || applianceElement.includes(search))) {
    ...
    appliancesOptionsDOM.forEach((element) => {
      element.addEventListener("click", activateFilter);
    });
  }
  async function createFilterOptionUstensil(search) {
    ...
    ustensilsList.forEach((ustensilElement) => {
      if (!selectedUstensils.includes(ustensilElement) && (search == void 0 || search == "" || ustensilElement.includes(search))) {
    ...
    ustensilsOptionsDOM.forEach((element) => {
      element.addEventListener("click", activateFilter);
    });
  }
  ...
  async function addToUstensilsList(ustensils) {
